...
class _printhistoryState extends State<printhistory> {
  ...
  _loadData() async {
    ...
    setState(() {
      data = ApiService().getPrintHistory(userId);
    });
  }
                                  ...
                                  children: [
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "START:" + snapshot.data![index].start.toString(),
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ),
                                          Text(
                                            "END:" + snapshot.data![index].end.toString(),
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ),
                                          Text(
                                          ...
                                          Text(
                                            "NO OF COPY:" + snapshot.data![index].noofcopy.toString(),
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ),
                                        ],
                                      ),
